            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        self.HPBefore = self.playerPokemon.HP
                        self.attackBefore = self.playerPokemon.attack
                        self.defenseBefore = self.playerPokemon.defense
                        self.speedBefore = self.playerPokemon.speed
                        ...
                        gStateStack:push(MenuState(self,
                        function()
